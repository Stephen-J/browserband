...
int keyCode = 0;
EMSCRIPTEN_KEEPALIVE void keypress(char *data,int size){
	keyCode = *((int*) data);
}
 ...
 */
 char termInitJsm = 1;
static void Term_init_jsm(term *t)
{
 ...
 */
static void Term_nuke_jsm(term *t)
{
	term_data *td = (term_data*)(t->data);
	char data[1];
	data[0] = 2;
 ...
 */
static errr Term_xtra_jsm(int n, int v)
{
	...
	switch (n)
	{
		...
		case TERM_XTRA_FLUSH:
		{
			 ...
			 */
			//EM_ASM(
			//	postMessage({type : "TermExtraFlush"});
		    //);
			char data[1];
			data[0] = 4;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraFlush\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_CLEAR:
		{
			 ...
			 */
			//EM_ASM(
			//	postMessage({type : "TermExtraClear"});
		    //);
			//emscripten_worker_respond_provisionally("TermExtraClear",14);
			char data[1];
			data[0] = 5;
			emscripten_worker_respond_provisionally(data,1);
			//waitForResponse(&Term_xtra_clear_handler);
			return (0);
		}
		...
		case TERM_XTRA_SHAPE:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraShape"});
		    //);
			char data[1];
			data[0] = 6;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraShape\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_FROSH:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraFrosh"});
		     //);
			 char data[1];
			data[0] = 7;
			emscripten_worker_respond_provisionally(data,1);
			// emscripten_worker_respond_provisionally("{function : \"TermExtraFrosh\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_FRESH:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraFresh"});
		    //);
			char data[1];
			data[0] = 8;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraFresh\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_NOISE:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraNoise"});
		    //);
			char data[1];
			data[0] = 9;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraNoise\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_BORED:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraBored"});
		    //);
			char data[1];
			data[0] = 10;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraBored\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_REACT:
		{
			 ...
			 */
			// EM_ASM(
			//	postMessage({type : "TermExtraReact"});
		    //);
			char data[1];
			data[0] = 11;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraReact\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_ALIVE:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraAlive"});
		    //);
			char data[1];
			data[0] = 12;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraAlive\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_LEVEL:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraLevel"});
		    //);
			char data[1];
			data[0] = 13;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraLevel\"}",29);
			return (0);
		}
		...
		case TERM_XTRA_DELAY:
		{
			 ...
			 */
			 //EM_ASM(
			//	postMessage({type : "TermExtraDelay"});
		    //);
			char data[1];
			data[0] = 14;
			emscripten_worker_respond_provisionally(data,1);
			//emscripten_worker_respond_provisionally("{function : \"TermExtraDelay\"}",29);
			return (0);
		}
	}
 ...
 */
static errr Term_curs_jsm(int x, int y)
{
	char data[3];
	data[0] = 17;
	data[1] = (char) x;
	data[2] = (char) y;
	emscripten_worker_respond_provisionally(data,3);
	return (0);
}
 ...
 * You may assume "valid" input if the window is properly sized.
 */
static errr Term_wipe_jsm(int x, int y, int n)
{
	term_data *td = (term_data*)(Term->data);
 ...
 */
static errr Term_text_jsm(int x, int y, int n, int a, const wchar_t *cp)
{
	term_data *td = (term_data*)(Term->data);
 ...
 */
static errr Term_pict_jsm(int x, int y, int n, const int *ap, const wchar_t *cp,
                          const int *tap, const wchar_t *tcp)
{
	term_data *td = (term_data*)(Term->data);
	int messageSize = 4 + 4 * n;
	char data[messageSize];
	data[0] = 16; // message type
	data[1] = x;
	data[2] = y;
	data[3] = n;
	for(int i = 4 , j = 0,k = 4 + n,l = 4 + 2 *n,m = 4 + 3 * n ; j < n ; i++,j++,k++,l++,m++){
		data[i] =  cp[j];
		data[k] = ap[j];
		data[l] = tcp[j];
		data[m] = tap[j];
	}
	emscripten_worker_respond_provisionally(data,messageSize);
	return (0);
}
...
static void term_data_link(int i)
{
	...
	t->init_hook = Term_init_jsm;
	t->nuke_hook = Term_nuke_jsm;

	/* Prepare the template hooks */
	t->xtra_hook = Term_xtra_jsm;
	t->curs_hook = Term_curs_jsm;
	t->wipe_hook = Term_wipe_jsm;
	t->text_hook = Term_text_jsm;
	t->pict_hook = Term_pict_jsm;
 ...
 */
const char help_jsm[] = "Describe XXX, subopts -describe suboptions here";


/**
 * Initialization function
 */
errr init_jsm(int argc, char **argv)
{
	int i;
	//EM_ASM(
	//	angband.init_jsm();
